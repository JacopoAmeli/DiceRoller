...
public class DiceRowDeckRenderer extends JPanel implements ActionListener,DiceRowRenderer {
	...
	private void initialize()
	{
		...
		CardsLeft.setPreferredSize(new Dimension(width/30,width/50));
		...
		containsJokers.setSelectedIcon(DicePictureGetter.getCheckedIcon());
		containsJokers.setIcon(DicePictureGetter.getUncheckedIcon());
		...
		shuffleButton.setIcon(DicePictureGetter.getShuffleIcon());
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		else if (arg0.getSource().equals(shuffleButton))
		{
			((DeckOfCards)set.getDice()).shuffle();
			this.logger.appendScroll("Shuffled deck");
		}
	}
	public void roll()
	{
